  ...
  return (
    ...
    <div className="max-w-4xl mx-auto relative">
      ...
      <div className="flex justify-end mb-4 pt-8 gap-4">
        ...
        <Button  variant="ghost">
          <a title='Mail me' href="mailto:martijn.vanhalen@gmail.com" target="_blank">
            <Mail className="h-5 w-5" />
          </a>
        </Button>
        <Button  variant="ghost" onClick={() => navigator.share({url: window.location.href,title: 'Martijn van Halen', text: 'Check out this portfolio!'})}>
      ...
      >
        ...
        <p className="mt-2">English | Dutch | Spanish</p>
      </motion.div>
